      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 sm:p-10">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-lg rounded-3xl bg-surface-3/95 backdrop-blur-xl border border-white/10 shadow-[0_24px_80px_-16px_rgb(0_0_0_/_0.6)] p-8 sm:p-10"
            role="dialog"
            aria-modal="true"
          >
