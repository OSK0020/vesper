  ...
  return (
    <div className="modal-overlay z-50">
      <div className="modal-content w-full max-w-4xl p-8 sm:p-10 relative animate-modal">
        ...
        <div className="flex items-center justify-between pb-6 border-b border-white/10 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400 mt-1">High-resolution 1200x630 preview graphic for social platforms</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="relative rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-black/40 p-1">
          <canvas
            ref={canvasRef}
        ...
        <div className="flex items-center justify-between mt-8 pt-6 border-t border-white/10 gap-6">
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <button
              ...
              className="action-btn action-btn-primary h-10 px-7 font-semibold"
            >
